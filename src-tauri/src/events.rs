...
/// in the house. `fields_from_input` is fallible since #12 (a weekly
/// pattern or ending that cannot serialize refuses here), and the refusal
/// reaches the CLI's socket exactly as it reaches the form.
